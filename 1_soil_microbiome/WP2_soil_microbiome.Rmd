...
```{r}
# Plot
p <- plot_ordination(psB_filtered5000_rel, pcoa.ord, color = "Pool") +
  geom_point(size = 2) +
  # stat_ellipse(aes(group = Field), alpha = 0.4) +
   theme(
    axis.text = element_text(size = 10),
...
ggsave("output/pcoaall_pool.png", p)
```
...
```{r}
# Plot
p <- plot_ordination(psB_filtered5000_rel, pcoa.ord, color = "DNAextraction") +
  geom_point(size = 2) +
  # stat_ellipse(aes(group = Field), alpha = 0.4) +
   theme(
    axis.text = element_text(size = 10),
...
ggsave("output/pcoaall_dnaextraction.png", p, width = 7, height = 4)
```
